...
// --- FAKE GAME DATA ---
// Includes games for testing calendar navigation and filtering
const fakeFixtures = [
    // --- Today (Sat, Apr 19, 2025 based on 'now') ---
    {
        fixtureId: 101, competition: "Premier League", country: "England",
        kickOffTime: new Date(now.getTime() + 2 * oneHour).toISOString(), // 14:00 UTC today
    ...
    },
    {
        ...
        kickOffTime: new Date(now.getTime() + 4 * oneHour).toISOString(), // 16:00 UTC today
    ...
    },
    {
        ...
        kickOffTime: new Date(now.getTime() + 5 * oneHour).toISOString(), // 17:00 UTC today
    ...
    },
    {
     ...
     {
        fixtureId: 203, competition: "Premier League", country: "England",
        kickOffTime: new Date(now.getTime() + 1 * oneDay + 6 * oneHour).toISOString(), // Sun 18:00 UTC
        status: 'SCHEDULED', homeTeam: { id: 6, name: "Man Citizens" }, awayTeam: { id: 5, name: "Mersey Reds" },
        odds: { homeWin: 1.7, draw: 4.0, awayWin: 4.8 }, result: null
    },
